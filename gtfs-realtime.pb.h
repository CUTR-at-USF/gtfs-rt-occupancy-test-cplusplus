...
class TripUpdate_TripProperties final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:transit_realtime.TripUpdate.TripProperties) */ {
 public:
  ...
  void Swap(TripUpdate_TripProperties* other);
  ...
  TripUpdate_TripProperties* New(::google::protobuf::Arena* arena) const final {
...
class TripUpdate final :
 ...
 public:
  ...
  static const int kTripPropertiesFieldNumber = 6;
...
class VehiclePosition_CarriageDetails final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:transit_realtime.VehiclePosition.CarriageDetails) */ {
 public:
  ...
  void Swap(VehiclePosition_CarriageDetails* other);
  ...
  VehiclePosition_CarriageDetails* New(::google::protobuf::Arena* arena) const final {
  ...
  static const int kCarriageSequenceFieldNumber = 5;
  ::google::protobuf::uint32 carriage_sequence() const;
  void set_carriage_sequence(::google::protobuf::uint32 value);
  ...
  static const int kOccupancyStatusFieldNumber = 3;
  ...
  static const int kOccupancyPercentageFieldNumber = 4;
  ::google::protobuf::int32 occupancy_percentage() const;
  void set_occupancy_percentage(::google::protobuf::int32 value);
 ...
 private:
  ...
  ::google::protobuf::uint32 carriage_sequence_;
  int occupancy_status_;
  ::google::protobuf::int32 occupancy_percentage_;
  friend struct ::TableStruct_gtfs_2drealtime_2eproto;
};
// -------------------------------------------------------------------
...
class VehiclePosition final :
 ...
 public:
  ...
  static const OccupancyStatus NO_DATA_AVAILABLE =
    VehiclePosition_OccupancyStatus_NO_DATA_AVAILABLE;
  static const OccupancyStatus NOT_BOARDABLE =
  ...
  static const int kMultiCarriageDetailsFieldNumber = 11;
  ::transit_realtime::VehiclePosition_CarriageDetails* mutable_multi_carriage_details(int index);
  ::google::protobuf::RepeatedPtrField< ::transit_realtime::VehiclePosition_CarriageDetails >*
  ...
  const ::google::protobuf::RepeatedPtrField< ::transit_realtime::VehiclePosition_CarriageDetails >&
  ...
  bool has_occupancy_percentage() const;
  void clear_occupancy_percentage();
  static const int kOccupancyPercentageFieldNumber = 10;
  ::google::protobuf::uint32 occupancy_percentage() const;
  void set_occupancy_percentage(::google::protobuf::uint32 value);
 ...
 private:
  ...
  ::google::protobuf::uint64 timestamp_;
  int occupancy_status_;
  ::google::protobuf::uint32 occupancy_percentage_;
  int current_status_;
  friend struct ::TableStruct_gtfs_2drealtime_2eproto;
};
// -------------------------------------------------------------------
...
class Alert final :
 ...
 public:
  ...
  static const Effect NO_EFFECT =
    Alert_Effect_NO_EFFECT;
  static const Effect ACCESSIBILITY_ISSUE =
  ...
  static const int kTtsHeaderTextFieldNumber = 12;
  ...
  static const int kTtsDescriptionTextFieldNumber = 13;
  ...
  static const int kSeverityLevelFieldNumber = 14;
...
class TripDescriptor final :
 ...
 public:
  ...
  PROTOBUF_DEPRECATED static const ScheduleRelationship REPLACEMENT =
    TripDescriptor_ScheduleRelationship_REPLACEMENT;
  static const ScheduleRelationship DUPLICATED =
...
inline void TripUpdate_TripProperties::set_trip_id(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
...
inline void TripUpdate_TripProperties::set_start_date(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000002u;
...
inline void TripUpdate_TripProperties::set_start_time(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000004u;
...
inline ::transit_realtime::TripUpdate_TripProperties* TripUpdate::mutable_trip_properties() {
  ...
  if (trip_properties_ == nullptr) {
    auto* p = CreateMaybeMessage<::transit_realtime::TripUpdate_TripProperties>(GetArenaNoVirtual());
    trip_properties_ = p;
  }
...
inline void TripUpdate::set_allocated_trip_properties(::transit_realtime::TripUpdate_TripProperties* trip_properties) {
  ...
  if (trip_properties) {
    ::google::protobuf::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      trip_properties = ::google::protobuf::internal::GetOwnedMessage(
...
inline void VehiclePosition_CarriageDetails::set_id(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline void VehiclePosition_CarriageDetails::set_label(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000002u;
...
inline ::google::protobuf::int32 VehiclePosition_CarriageDetails::occupancy_percentage() const {
...
inline void VehiclePosition_CarriageDetails::set_occupancy_percentage(::google::protobuf::int32 value) {
  _has_bits_[0] |= 0x00000010u;
...
inline ::google::protobuf::uint32 VehiclePosition_CarriageDetails::carriage_sequence() const {
...
inline void VehiclePosition_CarriageDetails::set_carriage_sequence(::google::protobuf::uint32 value) {
  _has_bits_[0] |= 0x00000004u;
...
inline ::google::protobuf::uint32 VehiclePosition::occupancy_percentage() const {
  // @@protoc_insertion_point(field_get:transit_realtime.VehiclePosition.occupancy_percentage)
  return occupancy_percentage_;
}
inline void VehiclePosition::set_occupancy_percentage(::google::protobuf::uint32 value) {
  _has_bits_[0] |= 0x00000100u;
  occupancy_percentage_ = value;
...
inline void Alert::set_allocated_tts_header_text(::transit_realtime::TranslatedString* tts_header_text) {
  ...
  if (tts_header_text) {
    ::google::protobuf::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      tts_header_text = ::google::protobuf::internal::GetOwnedMessage(
...
inline void Alert::set_allocated_tts_description_text(::transit_realtime::TranslatedString* tts_description_text) {
  ...
  if (tts_description_text) {
    ::google::protobuf::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      tts_description_text = ::google::protobuf::internal::GetOwnedMessage(
...
inline ::google::protobuf::uint32 EntitySelector::direction_id() const {
  // @@protoc_insertion_point(field_get:transit_realtime.EntitySelector.direction_id)
  return direction_id_;
}
inline void EntitySelector::set_direction_id(::google::protobuf::uint32 value) {
  _has_bits_[0] |= 0x00000020u;
  direction_id_ = value;
